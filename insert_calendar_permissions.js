...
async function insertCalendarPermissions() {
    let connection;
    try {
        connection = await mysql.createConnection(dbConfig);
        console.log('✅ Conectado a la base de datos.');

        // 1. Insertar el permiso 'calendar_read' si no existe
        const permissionName = 'calendar_read';
        const permissionDescription = 'Ver calendario de ordenes';
