...
async function insertPermissions() {
    ...
    try {
        ...
        const permissions = [
            { name: 'view_faq', description: 'Ver FAQ', module: 'faq' },
            { name: 'create_faq', description: 'Crear FAQ', module: 'faq' },
            { name: 'update_faq', description: 'Editar FAQ', module: 'faq' },
            { name: 'delete_faq', description: 'Eliminar FAQ', module: 'faq' }
        ];
